...
import com.sksamuel.reactivehive.{CreateTableConfig, DatabaseName, HiveWriter, PartitionPlan, ReactiveHiveFileNamer, StagingFileManager, Struct, TableName, WriteMode}
        ...
        try {
          ...
          if (writer == null)
            writer = new HiveWriter(
              ...
              new StagingFileManager(ReactiveHiveFileNamer.INSTANCE),
